...
def load_actions():
  execfile('init_load_board.py')
  execfile('init_simple_mdp.py')
  a_throw_list = []
  a_token_list = []
  ...
  return a_throw_list, a_token_list


def get_aiming_grid_custom_tokens(playername_filename, data_parameter_dir=fb.data_parameter_dir, grid_version='full'):

    a_throw_list, a_token_list = load_actions()
    temp_num = len(a_throw_list) + len(a_token_list)
    [prob_grid_normalscore, prob_grid_singlescore, prob_grid_doublescore, prob_grid_triplescore, prob_grid_bullscore] = load_prob_grid(playername_filename, data_parameter_dir=data_parameter_dir, grid_version=grid_version)    
    # temp_num = 1000
    aiming_grid = np.zeros((temp_num,2), dtype=np.int32)
    ...
    for a in a_throw_list: 
      temp_x = actions[a]['gaussian_centroid'][0]
      temp_y = actions[a]['gaussian_centroid'][1]
    ...
    for a in a_token_list:
        temp_x = token_actions[a]['gaussian_centroid'][0]
        temp_y = token_actions[a]['gaussian_centroid'][1]
        aiming_grid[temp_index] = [temp_x+170, temp_y+170]
        temp_index += 1
    ...
    # switch to token probabilities
    # playername_filename = 'playert'
    # [prob_grid_normalscore, prob_grid_singlescore, prob_grid_doublescore, prob_grid_triplescore, prob_grid_bullscore] = load_prob_grid(playername_filename, data_parameter_dir=data_parameter_dir, grid_version=grid_version)    
...
def save_aiming_grid_custom_tokens(playerID_list):    
    grid_version_result = 'custom_tokens'
    print('generate and save action set grid_version={}'.format(grid_version_result))
    for playerID in playerID_list:
        name_pa = 'player{}'.format(playerID)    
        [aiming_grid, prob_grid_normalscore, prob_grid_singlescore, prob_grid_doublescore, prob_grid_triplescore, prob_grid_bullscore] = get_aiming_grid_custom_tokens(name_pa, data_parameter_dir=fb.data_parameter_dir, grid_version='full')
...
def get_aiming_grid_custom_no_tokens(playername_filename, data_parameter_dir=fb.data_parameter_dir, grid_version='full'):
...
## save custom action set with no tokens
def save_aiming_grid_custom_no_tokens(playerID_list):    
    grid_version_result = 'custom_no_tokens'
    print('generate and save action set grid_version={}'.format(grid_version_result))
    for playerID in playerID_list:
        name_pa = 'player{}'.format(playerID)    
        [aiming_grid, prob_grid_normalscore, prob_grid_singlescore, prob_grid_doublescore, prob_grid_triplescore, prob_grid_bullscore] = get_aiming_grid_custom_no_tokens(name_pa, data_parameter_dir=fb.data_parameter_dir, grid_version='full')
...
def get_aiming_grid_custom_only_tokens(playername_filename, data_parameter_dir=fb.data_parameter_dir, grid_version='full'):

    a_throw_list, a_token_list = load_actions()
    temp_num = len(a_token_list)
    playername_filename = 'playert'
    [prob_grid_normalscore, prob_grid_singlescore, prob_grid_doublescore, prob_grid_triplescore, prob_grid_bullscore] = load_prob_grid(playername_filename, data_parameter_dir=data_parameter_dir, grid_version=grid_version)    
...
## save custom action set with no tokens
def save_aiming_grid_custom_only_tokens(playerID_list):    
    grid_version_result = 'custom_only_tokens'
    print('generate and save action set grid_version={}'.format(grid_version_result))
    for playerID in playerID_list:
        name_pa = 'player{}'.format(playerID)    
        [aiming_grid, prob_grid_normalscore, prob_grid_singlescore, prob_grid_doublescore, prob_grid_triplescore, prob_grid_bullscore] = get_aiming_grid_custom_only_tokens(name_pa, data_parameter_dir=fb.data_parameter_dir, grid_version='full')
